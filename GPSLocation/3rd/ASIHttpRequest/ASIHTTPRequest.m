...
- (void)applyCookieHeader
{
	...
	if ([self useCookiePersistence]) {
		...
		//modify by whhema start
		NSString* __host = [[self url] host];
		NSString* __path = [[self url] path];
		NSString* __scheme = [[self url] scheme];
		
		NSURL* cookieUrl = [[NSURL alloc] initWithScheme:__scheme host:__host path:__path];
